...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(line1.debit, Decimal('210.00'))

        self.assertEqual(line1.credit, Decimal('0'))
        self.assertEqual(line2.debit, Decimal('10.00'))

        self.assertEqual(line2.credit, Decimal('0'))
        self.assertEqual(line3.debit, Decimal('0'))

        self.assertEqual(line3.credit, Decimal('20.00'))
        self.assertEqual(line4.debit, Decimal('0'))

        self.assertEqual(line4.credit, Decimal('200.00'))
        ...
        self.assertEqual(line1.credit, Decimal('118.75'))
        self.assertEqual(line2.debit, Decimal('0'))

        self.assertEqual(line2.credit, Decimal('6.25'))
        ...
        self.assertEqual(line1.credit, Decimal('210.00'))
        self.assertEqual(line2.debit, Decimal('0'))

        self.assertEqual(line2.credit, Decimal('10.00'))
